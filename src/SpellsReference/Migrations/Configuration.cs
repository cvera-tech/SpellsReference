namespace SpellsReference.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SpellsReference.Data.Context>
    {
        ...
        protected override void Seed(SpellsReference.Data.Context context)
        {
            // Users
            var user1 = new User()
            {
            ...
            context.Users.AddOrUpdate(u => u.Email, user4);
            ...
            context.Spells.AddOrUpdate(s => s.Name, fireball);
            ...
            context.Spells.AddOrUpdate(s => s.Name, animateDead);
            ...
            context.Spells.AddOrUpdate(s => s.Name, mageHand);
            ...
            context.Spells.AddOrUpdate(s => s.Name, mirrorImage);
            ...
            context.Spells.AddOrUpdate(s => s.Name, counterspell);
            ...
            context.Spells.AddOrUpdate(s => s.Name, timeStop);
            var bless = new Spell()
            {
                Name = "Bless",
                Level = 1,
            ...
            context.Spells.AddOrUpdate(s => s.Name, bless);
            ...
            context.Spells.AddOrUpdate(s => s.Name, foresight);
            ...
            context.Spells.AddOrUpdate(s => s.Name, detectMagic);
            ...
            context.Spells.AddOrUpdate(s => s.Name, circleOfDeath);
            ...
            context.Spells.AddOrUpdate(s => s.Name, guidingBolt);
            var sleep = new Spell()
            {
                Name = "Sleep",
                Level = 1,
            ...
            context.Spells.AddOrUpdate(s => s.Name, sleep);
            ...
            context.Spells.AddOrUpdate(s => s.Name, stormOfVengeance);
            ...
            context.Spells.AddOrUpdate(s => s.Name, enlargeReduce);
            ...
            context.Spellbooks.AddOrUpdate(sb => sb.Name, spellbook1);
            var spellbook2 = new Spellbook()
            {
                Name = "Necronomicon",
            };
            spellbook2.Spells.Add(animateDead);
            context.Spellbooks.AddOrUpdate(sb => sb.Name, spellbook2);
            ...
            context.Spellbooks.AddOrUpdate(sb => sb.Name, spellbook3);
